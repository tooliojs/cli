...
try {
    ...
    if(config) {
        ...
        if(config.cli.color === 'none') { yargs.scriptName('toolio'); yargs.version(`Toolio CLI: v${version}`) } 
        else { yargs.scriptName(chalk[config.cli.color]('toolio')); yargs.version(chalk[config.cli.color](`Toolio CLI: v${version}`)) }
